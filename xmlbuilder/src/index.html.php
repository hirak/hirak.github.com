  ...
  ->body(array('style'=>'padding-top:90px;'))
    ...
    ->div(array('class'=>'navbar navbar-fixed-top'))
      ->div(array('class'=>'navbar-inner'))
        ->nav(array('class'=>'container'))
          ...
          ->ul(array('class'=>'nav'))
            ->li->a_(array('href'=>'#introduction'),'Introduction')->_
            ->li->a_(array('href'=>'#grammer'),'Grammer')->_
            ->li->a_(array('href'=>'#backends'),'Backends')->_
            ->li->a_(array('href'=>'#translate'),'XML ⇔ Array')->_
          ->_
        ->_
      ->_
    ->_
    ...
    ->div(array('class'=>'container'))
      ->header(array('class'=>'hero-unit'))
        ...
        ->a_(array('class'=>'btn btn-primary btn-large', 'href'=>'https://github.com/hirak/php-XML_Builder'), 'Download')
        ->_text(' ')
        ->a_(array('class'=>'btn btn-large', 'href'=>'https://github.com/hirak/php-XML_Builder'), 'Source Code')
      ->_
...
_TEXT_
      ...
      ->section(array('id'=>'grammer'))
        ...
        ->div
          ...
          ->table(array('class'=>'table table-bordered'))
            ->caption_('options')
            ->thead
              ->tr
                ->th_('name')
          ...
          ->p_('このXML_Builder::factory()でビルダーオブジェクトを作り、以下のmethodをmethod chainでつなげて書いていきます。')
          ->pre_($pretty, <<<'_PHP_'
